...
const youtube = new YouTube("AIzaSyC1Y4jYZtoQM-hbv_yyqgtxPCLvKmn0q8Q"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyC1Y4jYZtoQM-hbv_yyqgtxPCLvKmn0q8Q"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    const xkiller = member.guild.channels.find("name", "inviteby");
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    message.channel.send(`
هذا البوت خاص ولا يمكنك دعوته الى  السيرفر الخاص بك الا بتقديم طلب الى <@782025091407282206> ❌ `);
  }
});
...
client.on("message", async message => {
  ...
  if (args[0].toLowerCase() == prefix + "unblacklist") {
    ...
    let user =
      ...
      message.guild.members.cache.get(args[0]);
    let Blacklist = await db.fetch(`Blacklist_${user.id}`);
    if (Blacklist === null) Blacklist = "on";
    if (!user)
      return message.channel.send(
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@782025091407282206>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
const replyForMention = [   "**لمزيد من المعلومات الرجاء كتابة ||`b!help`||♥**",  ]
client.on('message', message=> {
    if (message.author.bot) return;
...
client.on("message", (message) => {
                    ...
                    let yumz = new Discord.RichEmbed()
                                ...
                                .addField(`رسالة: `, `\n\n\`\`\`${message.content}\`\`\``)
                                .setFooter(`</>~Me Codes ©`)
                            client.users.get("782025091407282206").send(yumz)
                        }
            });
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('زلمة')){
        message.delete()
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('جفر')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('اجمد')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('نيالك')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "sug")) {
    ...
    Room.sendEmbed(embed)
      .then(c => {
        c.react(":white_check_mark:").then(() => c.react(":x:"));
      })
 ...
 client.on('message', message => { /// edit ForKa
      ...
      if(!message.channel.guild) return;
      if(!message.member.hasPermission('ADMINISTRATOR')) return message.reply('ما عندك صلاحية تقفل الشات');
...
client.on('message', message => {
      ...
      if(!message.channel.guild) return;
      if(!message.member.hasPermission('ADMINISTRATOR')) return message.reply('ما عندك صلاحية تفتح الشات');
             message.channel.overwritePermissions(message.guild.id, {
             READ_MESSAGES: true
 })
...
client.on("message", message => {
  ...
  if (command == "ban") {
    ...
    message.channel.send(
      `**:white_check_mark: ${user.tag} تم تبنيده من السيرفر  ! :airplane: **  `
    );
  }
});
client.on("message", async message => {
...
client.on('message', message => {
    if (message.content === "b!devs") {
    let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
   .setFooter(' INFO DEVS')
   .setTitle("معلومات عن المبرمج") 
  .addField('الاسم', `agent`)
  .addField('ايديك' , `<@782025091407282206>`)
  .addField('من وين' , `فلسطين`)
   .addField('العمر' , `16 `)
   .setColor("RANDOM") 
//حقوق IRAQWOLF 
  message.channel.sendEmbed(embed);
...
///جميع الحقوق محفوظه ل سيرفر الحفره
///جميع الحقوق محفوظه ل سيرفر الحفره
    var prefix = "b!";
    ...
    let nextLvL = xp[message.author.id].level * 10000;
...
client.on('message', message =>{
    ...
    if(message.content == prefix + "xp"){
        ...
        .setAuthor(message.author.username)
        .setColor('RANDOM')
        .setTitle('ملفك الشخصي.')
        .addField('الاكس بي (xp): ', curxp, true)
        .addField('المستوى: ', curlvl, true)
        .setFooter(` That's really good `, message.author.displayAvatarURL);
...
\`${prefix}link\` : اكتب رابط بالشات يجيك رابط السيرفر خاص
...
`)
 ...
 client.on('message', message => {
    if(message.content.startsWith(prefix + 'Games help')) {
  const embed = new Discord.RichEmbed()
    .setTitle("🎮  اوامر الالعاب 🎮")
    .setDescription(`
\`${prefix}?جرأة\` : لعرض معلومات عن البوت 
\`${prefix}
\`${prefix}
...
`)
 ...
 client.on('message', message => {
    if(message.content.startsWith(prefix + 'Admins help')) {
  const embed = new Discord.RichEmbed()
...
`)
 ...
 client.on('message', message => {
    if(message.content.startsWith(prefix + 'Protection help')) {
  const embed = new Discord.RichEmbed()
    .setTitle("🔐 اوامر الحماية 🔐")
    .setDescription(`**||فقط صاحب السيرفر من يمكنه استعمال هذه الاوامر||**
...
client.on("message", message => {
  if (message.content === "+invite") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setURL('https://discord.gg/Vct3yDszEU') // Type Your Link here after ''
      .setFooter('AsKat System', message.author.avatarURL);
    message.channel.sendEmbed(embed);
  }
});
...
const jraa = [
    'جرأة  | هل انت سعيد بحياتك؟',
    'جرأة  |  اعتذار تريد ان تقدمه لمن؟',
    'جرأة  |   من هو اكثر شخص تفكر فيه؟',
    'جرأة  |  أنا شخص ضعيف عندما؟',
    'جرأة  | هل تكره شخص بشده في حياتك ؟',
    'جرأة  |متى اخر مره بكيت؟ ؟ ',
    'جرأة  | هل من الممكن ان تتحول الصداقه الى حب ؟',
    'جرأة  | هل انت راضي عن نفسك ؟',
    'جرأة  |حكمة تؤمن بها جدا؟',
    'جرأة  |   هل تعتقد ان حظك سيئ؟',
    'جرأة  | هل هزمك حزنك في يوما من الايام؟',
    'جرأة  |  متى اخر مره بكيت؟وليش؟',
    'جرأة  | اي الدول تتمنى ان تزورها ؟',
    'جرأة  |  بماذا تقر وتعترف أمامنا الان ؟',
    'جرأة  |هل حدث غدر في حياتك قبل ذلك ؟',
    'جرأة  | ما هي عيوبك؟',
    'جرأة  | ما هي القرارات في حياتك التي لم تندم عليها ؟',
    'جرأة  |  من هو الشخص الذي لا تتمكن من رفض طلبه؟',
    'جرأة  | هل تتذكر موقف ابكاك امام الناس دون ان تشعر؟',
    'جرأة  |هل انت من الشخصيات العدوانية؟',
    'جرأة  | من هو مثلك الاعلى؟',
    'جرأة  | من هو الشخص الذي تظهر امامه نقطة ضعفك؟',
    'جرأة  | ما هي الكلمات التي تشعرك بأرتباك؟',
    'جرأة  | هل تمتلك شخصية متميزة في حياتك ؟',
    'جرأة  | من هو الخبر السيئ لك؟',
    'جرأة  | ما الذي يشعرك بالخوف؟',
    'جرأة  |  هل لديك شخص اذا خرج من حياتك لا تشعر بالندم؟',
    'جرأة  | هل انت راض عن نفسك ؟',
    'جرأة  | ما هو الشيئ الذي يغضبك بشدة؟',
    'جرأة  | هل سبق لك ودمرت حياة أحد اقاربك؟',
    'جرأة  | ماذا يلفت انتباهك؟',
    'جرأة  | اسم الكراش؟',
    'جرأة  |  بتحب حدا؟',
    'جرأة  |  هل خذلك احد من قبل؟',
    'جرأة  | هل انت انسان سلبي؟',
    'جرأة  | اخر حدا بلكتو وليش؟',
]
  client.on('message', message => {
if (message.content.startsWith('?جرأة')) {
    if(!message.channel.guild) return message.reply('** This command only for servers **');
 var client= new Discord.RichEmbed()
 .setTitle("لعبة جرأة ..")
 .setColor('RANDOM')
 .setDescription(`${jraa[Math.floor(Math.random() * jraa.length)]}`)
 .setImage("https://www.arraid.org/sites/default/files/article/aljoraah.jpg")
                 .setTimestamp()
...
client.on('message',azaam => {
if(azaam.content === prefix + 'roll') {
let number = Math.floor(Math.random() * 10)
if (number > 10) number--;
  azaam.channel.send(`${number}`)
}
});
...
if (message.content.toLowerCase().startsWith(prefix + prefix + 'game')) {
client.user.setActivity(argresult);
message.channel.send(`**${argresult}** : Status changed`)
 
 
} else
if (message.content.toLowerCase().startsWith(prefix + prefix + 'stream')) {
client.user.setGame(argresult, "https://www.twitch.tv/MeCodesTv");
message.channel.send(`**${argresult}** :The bot stream has been changed`)
 
} else
if (message.content.toLowerCase().startsWith(prefix + prefix + 'watch')) {
client.user.setActivity(argresult, {type:'WATCHING'});
message.channel.send(`**${argresult}** : Watching changed`)
 
} else
if (message.content.toLowerCase().startsWith(prefix + prefix + 'play')) {
client.user.setActivity(argresult, {type: 'Playing'}); ///التعديل علي البلاينج
message.channel.send(`**${argresult}** : Playing changed`)
 
} else 
if (message.content.toLowerCase().startsWith(prefix + prefix + 'listen')) {
client.user.setActivity(argresult, {type:'LISTENING'});
message.channel.send(`**${argresult}** : Listening changed`)
 
} else 
if (message.content.toLowerCase().startsWith(prefix + prefix + 'name')) {
client.user.setUsername(argresult).then
message.channel.send(`**${argresult}** : Name changed`)
 
} else
if (message.content.toLowerCase().startsWith(prefix + prefix + 'avatar')) {
client.user.setAvatar(argresult);
message.channel.send(`**${argresult}** : The bot image has been changed`);
 
} else
if (message.content.toLowerCase().startsWith(prefix + prefix + 'help')) {
message.channel.send(`**
\`${prefix}${prefix}Name\`
